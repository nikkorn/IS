...
/**
 * Factory for creating a mail box.
 */
public class MailBoxFactory implements TileFactory {
	...
	public Entity create(Engine engine, Random random, int x, int y, boolean sameAbove) {
		...
		// Add the mail box texture.
		entity.add(new TextureComponent(Assets.mail_box));
